...
<!--                            <li class="navbar-item">
    ...
    <section class="static about-sec">
        <div class="container">
            ...
            <p> </p>
            <div class="form">
                <form action="vallog.jsp">
                    <div class="row">
                        <div class="col-md-5">
                            <input placeholder="Enter User Name" name="uname" maxlength="12" autocomplete="off" required>
                            <span class="required-star">*</span>
                        </div>
                        <div class="col-md-5">
                            <input type="password" placeholder="Enter Password" maxlength="12" name="pass" autocomplete="off" required>
                            <span class="required-star">*</span>
                        </div>
                        <div class="col-md-5">
